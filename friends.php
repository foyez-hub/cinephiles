                ...
                <h1 style="margin-top:15px; text-align:center" class="movie-list-title ">Friend Request</h1>
                    ...
                    <div class="movie-list">
                        ...
                        $name= $row['name'];
                            ...
                            <a href="profile.php?acceptrequest='.$value.'"> <input class="movie-list-item-button1" name="addfriend" type="submit" value="Accept Request"> </a>
                            <a href="profile.php?cancel='.$value.'"> <input class="movie-list-item-button1" name="X" type="submit" value="X"> </a>
                ...
                <h1 style="margin-top:15px; text-align:center" class="movie-list-title ">Friend List</h1>
                    ...
                    <div class="movie-list">
                        ...
                        $name= $row['name'];
                            ...
                            <a href="view_profile.php?title='.$value.'"> <input class="movie-list-item-button" type="submit" value="View Profile"> </a>
                            <a href="profile.php?unfriend='.$value.'"> <input class="movie-list-item-button1" name="X" type="submit" value="Unfriend"> </a>
                ...
                <h1 style="margin-top:15px; text-align:center" class="movie-list-title ">Sent Request</h1>
                    ...
                    <div class="movie-list">
                        ...
                        $name= $row['name'];
                           ...
                           <a href="profile.php?cancelsr='.$value.'"> <input class="movie-list-item-button1" name="X" type="submit" value="X"> </a>
